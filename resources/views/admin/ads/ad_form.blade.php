            ...
            <div class="widget-header">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group inside">
                        <label for="users">{{ __('messages.product_name') }}</label>
                        @php $products = \App\Product::where('deleted',0)->get(); @endphp
                        <select required class="form-control tagging" name="product_id">
